...
Route::post('/pendaftaran/kirim', [PendaftarController::class, 'kirim_data'])->name('pendaftar.kirim');

Route::get('/tidak-lolos/{id}', [\App\Http\Controllers\AdminController::class, 'tidak_lolos'])->name('tidak_lolos');
