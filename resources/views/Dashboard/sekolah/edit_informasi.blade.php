    ...
    <div class="main-content">
      ...
      <div class="row">
        ...
        <div class="card">
          ...
          <div class="row">
            ...
            <form action="{{route('update_informasi', $data->id)}}" method="post" enctype="multipart/form-data">
              ...
              <label class="{{ $errors->get('judul') ? 'text-danger' : '' }}">Judul Informasi<sup
                class="text-danger">*</sup></label>
              <input type="text" name="judul"
                class="form-control {{ $errors->get('judul') ? 'is-invalid' : '' }}"
                placeholder="MTs Darul Muqodas Semakin Berprestasi!" value="{{ $data->judul }}">
              @if ($errors->get('judul'))
        ...
        @endif
              ...
              <label class="{{ $errors->get('informasi') ? 'text-danger' : '' }}">Informasi<sup
                class="text-danger">*</sup></label>
              <textarea name="informasi" id="konten2"
                class="form-control {{ $errors->get('informasi') ? 'is-invalid' : '' }}" cols="30"
                rows="10">{{ $data->informasi }}</textarea>
        ...
        @endif
              ...
              <label for="formFile"
                ...
                Image</label>
              <input class="form-control {{ $errors->get('banner_image') ? 'is-invalid' : '' }}" type="file"
                name="banner_image" id="image" placeholder="image" />
        ...
        @endif
              ...
              <div class="form-group mt-2">
              <label for="category"
                class="form-label {{ $errors->get('category') ? 'text-danger' : '' }}">Kategori</label>
