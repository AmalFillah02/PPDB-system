                                                    ...
                                                    <td>
                                                        ...
                                                        <ul class="dropdown-menu" aria-labelledby="dropdownMenuLink">
                                                            <li><a class="dropdown-item"
                                                                    href="{{ route('acc', $dp->id) }}">ACC</a></li>
                                                            <li><a class="dropdown-item"
                                                                    href="{{ route('lihat', $dp->id) }}">Lihat</a></li>
                                                            <li><a class="dropdown-item text-danger"
                                                                    href="{{ route('tidak_lolos', $dp->id) }}">Tidak Lolos</a>
                                                            </li>
                                                        </ul>
                                                    </td>
                                                </tr>
                            ...
                            <div class="card">
                                ...
                                <div class="card-body table-responsive">
                                    ...
                                    {{-- <button class="btn btn-success mb-2"
                                        onclick="exportData('xlsx', 'data_acc')">Excel</button> --}}
                                            ...
                                            @foreach($data_acc as $dc)
                                                <tr>
                                                    ...
                                                    <td>
                                                        ...
                                                        <ul class="dropdown-menu" aria-labelledby="dropdownMenuLink">
                                                            <li><a class="dropdown-item"
                                                                    href="{{ route('lihat', $dc->id) }}">Lihat</a></li>
                                                            <li><a class="dropdown-item"
                                                                    href="{{ route('hapus_siswa', $dc->id) }}">Hapus</a></li>
                                                        </ul>
                                                    </td>
                                                </tr>
                                            @endforeach
